          ...
          const request = async (method, endpoint, body = null, isForm = false, retry = true) => {
            let token = getToken()
          ...
          async function handleResponse(response) {
            ...
            if (!response.ok) {
              ...
              const errorMessage = getErrorMessage(data, response.status, response.statusText)
          ...
          export const post = (endpoint, body, isForm = false) => request("POST", endpoint, body, isForm)
          ...
          // 🔐 Auth Functions
          export const postLogin = (email, password) => post("/auth/login/", { email, password })
          ...
          export const confirmPasswordReset = (uidb64, token, new_password1, new_password2) =>
          ...
          export const getPopularProfiles = () => get("/admin/dashboard/popular-profiles/")
          ...
          export const patchReportById = (reportId, data) => patch(`/admin/reports/${reportId}/`, data)
          export const putReportById = (reportId, data) => put(`/admin/reports/${reportId}/`, data) // optional: full replace
          export const deleteReportById = (reportId) => del(`/admin/reports/${reportId}/`)

          // 👥 Admin Users APIs
          export const getUsers = () => get("/admin/users/")
          export const getUserById = (userId) => get(`/admin/users/${userId}/`)
          export const patchUserById = (userId, data) => patch(`/admin/users/${userId}/`, data)
          export const putUserById = (userId, data) => put(`/admin/users/${userId}/`, data) // optional: full replace
          export const deleteUserById = (userId) => del(`/admin/users/${userId}/`)
          export const banUserById = (userId) => post(`/admin/users/${userId}/ban/`)
          export const suspendUserById = (userId) => post(`/admin/users/${userId}/suspend/`)
          ...
          export const patchAdminById = (adminId, data) => patch(`/admin/admins/${adminId}/`, data)
          export const putAdminById = (adminId, data) => put(`/admin/admins/${adminId}/`, data) // optional
          ...
          export const setPrimaryPhoto = (photoId) => post(`/profile/photos/set-primary/${photoId}/`)

          // Get account settings
          export const fetchAccountSettings = () => get("/profile/settings/account/")

          // Update account settings
          export const updateAccountSettings = (data) => put("/profile/settings/account/", data)

          // Partially update account settings
          export const patchAccountSettings = (data) => patch("/profile/settings/account/", data)

          // Match preferences (already in your code)
          export const updateUserPreferences = (data) => patch("/match-preferences/", data)

          // Search for matches
          export const searchMatches = (params) => get("/profile/matches/search/", params)

          // 💘 Matchmaking
          export const sendLike = (targetUserId) => post(`/matchmaking/like/${targetUserId}/`)
          export const sendShortlist = (targetUserId) => post(`/matchmaking/shortlist/${targetUserId}/`)
          export const reportUser = (userId, data) => post(`/matchmaking/report/${userId}/`, data)
          export const blockUser = (userId) => post(`/matchmaking/block/${userId}/`)
          export const fetchShortlisted = () => get("/matchmaking/shortlisted/")
          export const updateMatchStatus = (userId, data) => put(`/matchmaking/update-status/${userId}/`, data)
          export const patchMatchStatus = (userId, data) => patch(`/matchmaking/update-status/${userId}/`, data)
          ...
          export const getUnmessagedMatches = () => get("/matchmaking/matches/unmessaged/")
          ...
          export const getMatchmakingDashboardSummary = () => get("/matchmaking/dashboard/summary/")

          // 💬 Matchmaking Chat
          export const sendMessage = (receiverId, message) => post("/matchmaking/chat/send-message/", { receiverId, message })
          export const getChatRooms = () => get("/matchmaking/chat-rooms/")
          export const getChatMessages = (roomId) => get(`/matchmaking/chat-rooms/${roomId}/messages/`)
          export const sendChatMessage = (roomId, data) => post(`/matchmaking/chat-rooms/${roomId}/messages/`, data)

          // 📨 Matchmaking Messages
          export const getUnreadMessages = () => get("/matchmaking/messages/unread/")
          export const getUnreadMessageCount = () => get("/matchmaking/messages/unread/count/")
          ...
          export const updateNotificationSettings = (data) => put("/notifications/settings/", data)
          export const patchNotificationSettings = (data) => patch("/notifications/settings/", data)
          export const getUnreadNotificationCount = () => get("/notifications/unread/count/")

          // 💞 Match Preferences APIs
          export const getMatchPreferences = () => get("/match-preferences/")
          export const updateMatchPreferences = (data) => put("/match-preferences/", data)
          export const patchMatchPreferences = (data) => patch("/match-preferences/", data)
